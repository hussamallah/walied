...
export default function CV({ isEnglish }: CVProps) {
  return (
    <section className="section" id="cv">
      <h2>{isEnglish ? "Follow Me on Instagram" : "تابعني على إنستغرام"}</h2>
      <div className="card" style={{ textAlign: "center" }}>
        <h3>@waleed_alhalfawy</h3>
        <div style={{ 
          width: "100%", 
          maxWidth: "540px", 
          margin: "0 auto",
          ...
          <blockquote 
            ...
            data-instgrm-permalink="https://www.instagram.com/p/DG9BQodCyct/?utm_source=ig_embed&amp;utm_campaign=loading" 
          ...
          >
            <div style={{ padding: "16px" }}>
              <a 
                href="https://www.instagram.com/p/DG9BQodCyct/?utm_source=ig_embed&amp;utm_campaign=loading" 
                style={{ 
                  background: "#FFFFFF", 
                  lineHeight: "0", 
                  padding: "0 0", 
              ...
              <p style={{ color: "#c9c8cd", fontFamily: "Arial,sans-serif", fontSize: "14px", lineHeight: "17px", marginBottom: "0", marginTop: "8px", overflow: "hidden", padding: "8px 0 7px", textAlign: "center", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                <a href="https://www.instagram.com/p/DG9BQodCyct/?utm_source=ig_embed&amp;utm_campaign=loading" style={{ color: "#c9c8cd", fontFamily: "Arial,sans-serif", fontSize: "14px", fontStyle: "normal", fontWeight: "normal", lineHeight: "17px", textDecoration: "none" }} target="_blank">A post shared by Waleed Alhalfawy (@waleed_alhalfawy)</a>
              </p>
            </div>
          </blockquote>
        </div>
        <p style={{ marginTop: "16px", color: "#cbd5e1" }}>
          {isEnglish ? "Follow the latest updates and training on Instagram" : "تابع آخر التحديثات والتدريبات على إنستغرام"}
        </p>
        <a 
        ...
        >
          {isEnglish ? "Follow on Instagram" : "تابع على إنستغرام"}
        </a>
      </div>
    </section>
  );
