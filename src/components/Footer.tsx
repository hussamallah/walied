    ...
    <footer className="wrap" style={{
      ...
      <div style={{
        ...
        >
          ...
          {isEnglish ? "Contact me on WhatsApp" : "تواصل معي على واتساب"}
        </a>
        ...
        <div style={{
          ...
          {isEnglish ? "Privacy first · You can cancel anytime" : "الخصوصية أولاً · يمكنك الإلغاء في أي وقت"}
        </div>
      </div>
      ...
      <div style={{
        ...
        width: "100%"
            ...
            <div>&copy; {year} LEVEL UP — {isEnglish ? "Waleed Alhalfawy" : "وليد الحلفاوي"}</div>
      </div>
    </footer>
  );
}
